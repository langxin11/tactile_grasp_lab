...
private:
	...
	void addPillarSlipSample(IN const int8_t pillarSlipStates[MAX_NPILLAR], IN const float pillarFrictionEstimates[MAX_NPILLAR]);
	void copy(OUT PTSDKSensor *pSensorDest);
